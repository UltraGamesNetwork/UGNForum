    ...
    <div id="chatter" class="chatter_home">
        ...
        <div id="chatter_hero">
            ...
            @if( isset( $headline_logo ) && !empty( $headline_logo ) )
                ...
                <img src="https://cdn.discordapp.com/attachments/300639925206777866/502464681667985410/UGN_Banner_2x.png">
            @else
{{--                <h1>@lang('chatter::intro.headline')</h1>--}}
                <h1>Welkom op het UGN Forum</h1>
                <p>Het gezelligste forum van deze minecraft server!</p>
            @endif
        </div>
        ...
        <div class="container chatter_container">
            ...
            <div class="row">
                ...
                <div class="col-md-3 left-column card">
                    <!-- SIDEBAR -->
                    <div class="chatter_sidebar pt-2">
                        <button class="btn btn-outline-primary" id="new_discussion_btn"><i class="chatter-new"></i> @lang('chatter::messages.discussion.new')</button>
